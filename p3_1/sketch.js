...
function draw() {
    ...
    ////
    tt.position(windowWidth-170, windowHeight / 2-125);
    len.position(windowWidth-177, windowHeight / 2-105);
    trans.position(windowWidth-176, windowHeight / 2-85);
    up_down.position(windowWidth-189, windowHeight / 2-65);
    ///
...
function checking() {
    for (var i = 0; i < buildings.length; i++) {
        if ((a + 25 == buildings[i].xposition) && (b + 25 == buildings[i].yposition)) {
            ...
            trans.show();
            up_down.show();
            huesliders[i].position(windowWidth-150, windowHeight / 2-120);
            hsliders[i].position(windowWidth-150, windowHeight / 2 -100);
            asliders[i].position(windowWidth-150, windowHeight / 2 -80);
            tsliders[i].position(windowWidth-150, windowHeight / 2 -60);
